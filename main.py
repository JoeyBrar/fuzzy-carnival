...
async def on_ready():
    ...
    await yagChannel.send('bot is online')
    await client.change_presence(activity=discord.Game('GTA 7'))
...
client.run('ODY3NDQyMTUyNDYwMjU1MjQz.YPhKdQ.byPRNmISmhsOz2DjXJiXz5At8og')